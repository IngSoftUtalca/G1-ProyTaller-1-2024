    ...
    <div class="container-fluid ligth-bg">
        ...
        <form @submit.prevent="addPeriodo" class="container-fluid">
            <div class="row d-flex justify-content-center align-items-center my-52">
                ...
                <div class="col">
                    <input type="date" id="Inicio" class="text-input">
                </div>
                <div class="col">
                    <label for="Termino" class="bold font-16">Fecha termino:</label>
                </div>
                <div class="col">
                    <input type="date" id="Termino" class="text-input">
                </div>
            </div>
            <div class="row d-flex justify-conten-start align-items-center my-52">
                ...
                <div class="col w-150">
                    <input type="date" id="Feriado" class="text-input">
                </div>
                <div class="col w-120">
            ...
            <div class="row d-flex justify-conten-start align-items-center my-52" >
                ...
                <div class="col">
                    <div class="row">
                        <div class="col w-120">
                            <input type="file" id="Horarios" class="text-input"
                            @change="fileUpload" 
                            ref="fileInput" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" 
                            style="display: none;">
                            <button class="btn-primary-16 btn-size-120 d-flex align-items-center justify-content-center" @click.prevent="selectFile">
                                <span class="bold">
                                    Subir
                                </span>
            ...
            <div class="row mt-64">
                ...
                <div class="col ms-5 d-flex justify-content-start">
                    <div class="row btn-size-120">
                        <button class="btn-primary-16 bold" type="submit">Guardar</button>
                    </div>
                </div>
            </div>
        </form>
