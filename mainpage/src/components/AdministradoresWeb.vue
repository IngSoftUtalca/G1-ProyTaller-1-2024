<template>
  <div class="container-fluid d-flex w-90">
    <div class="col d-flex justify-content-end">
      <table class="w-90 mx-4 mt-3 text-center gray-border" v-if="!loading" :key="count">
        ...
        <tbody class="secondary-bg">
          <tr class="h-36" v-for="(admin, index) in administradores" :key="index">
            ...
            <td class="gray-border h-36 px-3 d-flex justify-content-end align-items-center">
              <button class="btn-gray btn-size-85 bold font-12" @click="deleteAdmin(admin.RUT)">
    ...
    <div class="col mt-4 w-120" v-if="!loading">
  ...
  <!-- loading-->
  <div class="container d-flex justify-content-start align-items-center h-450" v-if="loading">
