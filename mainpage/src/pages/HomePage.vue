<template>
  <div
    class="container-fluid d-flex justify-content-center align-items-center fullscreen"
    v-if="loading"
  >
  ...
  <div v-if="!loading">
    ...
    <div class="container-fluid mt-108 w-95">
      ...
      >
        <div
          class="col w-220 me-4 rt-50 p-0 d-flex justify-content-center align-items-center"
          :class="asistencia ? 'secondary-bg' : 'primary-bg'"
          @click="selectAsistencia"
        ...
        <div
          class="col w-220 me-4 rt-50 p-0 d-flex justify-content-center align-items-center"
          :class="horarios ? 'secondary-bg' : 'primary-bg'"
          @click="selectHorarios"
          v-if="userType == 'docente'"
        >
        ...
        <div
          class="col w-220 me-4 p-0 rt-50 d-flex justify-content-center align-items-center"
        ...
        <div
          class="col w-220 p-0 rt-50 d-flex justify-content-center align-items-center"
